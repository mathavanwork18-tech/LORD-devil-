      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md">
        ...
        >
          ...
          <div className="py-5 space-y-5 text-xs font-mono">
            ...
            {/* Procedural Drone Ambience Generator */}
            <div className="pt-2 border-t border-void-purple/20 flex items-center justify-between">
              <div className="flex items-center gap-2 text-void-200">
                <Music className="w-4 h-4 text-void-purple" />
                <span>Procedural Void Drone (55Hz)</span>
              </div>
              <button
              ...
              >
                {droneEnabled ? 'STOP DRONE' : 'START DRONE'}
              </button>
            </div>
